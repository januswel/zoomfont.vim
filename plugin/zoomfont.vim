...
"   https://github.com/januswel/zoomfont.vim/blob/master/LICENSE
...
function! s:ChangeFontSize(func, font)
    ...
    for setting in settings
        ...
        if current == -1
            " when setting is not font size
            call add(newsettings, setting)
            continue
        else
            " when setting is font size
...
function! s:GetFontSizeUser()
    ...
    if !empty(font)
        ...
        throw "Can't get default font size."
    endif
endfunction
